  ...
  return (
    <section className="w-full h-contain mt-4 py-6 px-12 lg:mt-6 lg:py-10 lg:px-20 bg-transparent flex flex-col justify-start items-center">
      <div className="w-[300px] h-[225px] md:w-[400px] md:h-[300px] lg:w-[560px] lg:h-[350px] flex justify-center items-start [&>*:nth-child(1)]:hover:bg-yellowLight">
        <div
            className="bg-whiteLight w-[40%] h-[40%] lg:w-[50%] lg:h-[60%] bg-cover transition duration-700 ease-in-out"
          >
          <div
            className="w-full h-full flex flex-col justify-start items-center relative group cursor-pointer bg-transparent [&>*:nth-child(1)]:hover:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#FAFF00] from-0% to-transparent to-80% transition-all duration-1000 ease-in-out"
          >
      ...
      <motion.div
        ...
        className="max-w-[300px] leading-[40px] md:max-w-[400px] md:leading-[50px] lg:max-w-[500px] text-[45px] md:text-[60px] lg:text-[76px] font-extralight uppercase text-center lg:leading-[76px] drop-shadow-xl md:-mt-16 lg:-mt-0"
      >
        Bring your <span className="font-bold">Idea</span></motion.div>
    </section>
  )
}
