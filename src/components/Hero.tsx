    ...
    <section className="w-full h-contain mt-4 py-6 px-12 lg:mt-6 lg:py-10 lg:px-20 bg-transparent flex flex-col justify-start items-center">
      <div className="w-[300px] h-[225px] md:w-[400px] md:h-[300px] lg:w-[560px] lg:h-[350px] flex justify-center items-start [&>*:nth-child(1)]:hover:bg-yellowLight">
        <motion.div 
          ...
          >
          <div className="w-full h-full flex flex-col justify-start items-center relative group cursor-pointer bg-transparent [&>*:nth-child(1)]:hover:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#FAFF00] from-0% to-transparent to-80% transition-all duration-1000 ease-in-out">
