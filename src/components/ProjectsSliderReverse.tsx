  ...
  return (
    <div className="relative w-full h-contain flex gap-96 flex-nowrap overflow-hidden">
      <div className="flex w-full">
        <div className="project min-w-full min-h-[60vh] grid grid-cols-2 gap-16">
          <div
            className="bg-blue rounded-br-[96px] w-full py-10 pr-16 flex items-center"
          >
            <motion.img 
          ...
          <motion.div
            className="flex flex-col gap-4 text-[24px] leading-[32px] font-light max-w-[500px]"
            key={currentIndex}
            initial="hidden"
            animate="visible"
      ...
      <div
        id="arrowRight"
        className={`flex absolute top-0 left-10 h-full w-[100px] justify-center items-center cursor-pointer`}
        onClick={nextProject}
      >
