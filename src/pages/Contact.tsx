  ...
  return (
    <>
      <section className="h-contain p-4 md:py-10 md:px-20 w-full flex flex-col gap-20 items-center justify-center">
        <div className="w-full h-contain bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-lightBlue from-0% to-blue/20 to-80% rounded-t-[70px] rounded-b-2xl px-6 py-10 md:px-20 md:py-10 flex items-center justify-center">
        ...
        <div className="w-full h-contain bg-gradient-to-b from-black/30 to-blue backdrop-blur-lg rounded-2xl px-6 py-16 md:px-20 md:py-28 shadow-lg">
          <div className="w-full h-full grid grid-cols-1 lg:grid-cols-2 gap-10 bg-stars bg-left-top bg-no-repeat">
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-2 w-full">
                ...
                <input type="text" className="px-3 py-4 rounded-sm bg-blue border-[1px] border-lightBlue/30 text-[16px] font-light placeholder:text-[16px] placeholder:text-white/60 placeholder:font-light" placeholder="Enter First Name"/>
              </div>
              <div className="flex flex-col gap-2 w-full">
                <p className="text-[16px] font-medium">Email</p>
                <input type="text" className="px-3 py-4 rounded-sm bg-blue border-[1px] border-lightBlue/30 placeholder:text-[16px] placeholder:text-white/60 placeholder:font-light text-[16px] font-light" placeholder="Enter Email"/>
              </div>
              <div className="flex flex-col gap-2 w-full">
                <p className="text-[16px] font-medium">Project Type</p>
                <input type="text" className="px-3 py-4 rounded-sm bg-blue border-[1px] border-lightBlue/30 placeholder:text-[16px] placeholder:text-white/60 placeholder:font-light text-[16px] font-light" placeholder="Enter Project Type like UI/UX design"/>
              </div>
              <div className="flex flex-col gap-2 w-full">
                <p className="text-[16px] font-medium">Message</p>
                <textarea className="px-3 py-4 min-h-[200px] rounded-sm bg-blue border-[1px] border-lightBlue/30 placeholder:text-[16px] placeholder:text-white/60 placeholder:font-light text-[16px] font-light" placeholder="Enter Your Message"/>
              </div>
            ...
            <div className="border-[1px] border-lightBlue/30 rounded-lg w-full flex flex-col gap-[40px] items-center justify-center backdrop-blur-md py-[40px] px-[30px] md:px-[60px]">
